...
export async function makeRequest<T = unknown>(
  ...
  console.warn("[Maps] Google Maps proxy (Manus) is disabled. Please integrate directly with Google Maps API.");
  throw new Error("Maps service not configured for self-owned stack.");
}
